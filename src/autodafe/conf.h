...
struct struct_source {
  ...
  char *filename;         /* pointer on a heap buffer containing the name */
...
typedef struct configuration {
  ...
  char *dbg_host;         /* hostname of the autodafe's debugger */
  ...
  char *fuzz_file_dir;    /* where put the fuzzed files */
  ...
  char *buf_fuzz;         /* pointer to the current buffer fuzz */
